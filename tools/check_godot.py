...
expected=next((marker for name,marker in [('release_suite.gd','RELEASE_TESTS'),('input_suite.gd','INPUT_TESTS'),('visual_release.gd','VISUAL_RELEASE_TESTS'),('release_gate.gd','RELEASE_GATE_OK')] if any(name in a for a in sys.argv[2:])),None)
