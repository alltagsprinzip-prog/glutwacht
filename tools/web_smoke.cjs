...
(async()=>{
 ...
 try {
  ...
  await tap(500,234);await page.keyboard.type('player-a@example.test');
  await tap(500,323);await page.keyboard.type('Test-only-password-123');
  await tap(430,502);
  ...
  await friend.touchscreen.tap(500,234);await friend.keyboard.type('player-b@example.test');
  await friend.touchscreen.tap(500,323);await friend.keyboard.type('Test-only-password-123');
  await friend.touchscreen.tap(840,502);
  ...
  await tap(500,234);await page.keyboard.type('player-a@example.test');
  await tap(500,323);await page.keyboard.type('Test-only-password-123');await tap(430,502);
  await wait(()=>window.__glutwacht?.mode==='home' && window.__glutwacht.dialog==='');
