...
static func scout(g):
 ...
 text(g,v.name,Rect2(35,26,359,39),31,GOLD);text(g,"KI-Lager · Stärke %d"%g.Catalog.village_strength(v),Rect2(36,68,357,32),24)
 for i in range(3):
 ...
 g.button(g.hud,"Nächstes Dorf",Rect2(470,608,335,96),func():g.scout_next())
