...
- Auth-Tokens bleiben nur im Arbeitsspeicher; keine Passwörter/Service-Keys im Repo oder Export. Nach Neustart erneut anmelden. Token-Erneuerung und Passwort-Wiederherstellung noch offen.
